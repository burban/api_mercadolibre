...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Registros Correos API-Mercado Libre Automatica</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="data-correos" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Correos</th>
                                            <th>Accion</th>
                        ...
                        <div class="card-footer text-center"><button type="button" class="btn btn-primary">Agregar Nuevo Correo</button></div>
                    </div>
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="addNewEmail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ingresa Nuevo Correo</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input class="form-control" type="email" id="email-text" placeholder="tu-correo@ejemplo.cl"/>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                    <button class="btn btn-primary" id="addEmail" type="button">Guardar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <label>Sitio MQ</label>
                        <p>Bienes con Raíces</p>
                        <img src="img/black-hole.svg" title="En algún lugar algo increíble está esperando ser descubierto">
                    </div>
                <div class="text-center">
